#!/usr/bin/env python3
"""
Secure update script for MyDramaList Bot.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Secure updater for MyDramaList Bot",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python update.py --repo https://github.com/user/repo.git
  python update.py --repo https://github.com/user/repo.git --branch develop
